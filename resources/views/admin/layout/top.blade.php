    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{url('admin/dashboard')}}" target="_blank">
          <img src="{{asset('halaman/img/logo.png')}}" class="navbar-brand-img" alt="main_logo"/>
          <span class="ms-1 font-weight-bold text-white">MEKARYA</span>
        </a>
      </div>
        ...
        <div class="container-fluid py-1 px-3">
          ...
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            {{-- <ul class="navbar-nav justify-content-end">
              ...
              <li class="mt-2">
                <a class="github-button" href="https://github.com/creativetimofficial/material-dashboard" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star creativetimofficial/material-dashboard on GitHub"
                  >Star</a
                >
              </li> --}}
